 ...
 */
window.utils.captureMouse = function (element,game) {
  var mouse = {x: 0, y: 0, down:false, up:false, down_x:0, down_y:0, up_x:0, up_y:0, event: null},
  ...
  element.addEventListener('mouseup', function (event) {
    ...
    if(game.selected_ball != null){
      //new move
      game.currentPlayerFirstHit = false;
      game.currentPlayerLastHit = false;
      if(game.selected_ball.id != "move" && game.selected_ball.id != "rotate"){
        var vx = (game.selected_ball.x - this.up_x) * 0.1;
        var vy = (game.selected_ball.y - this.up_y) * 0.1;
        
        game.selected_ball.startPoint = new Point2D(game.selected_ball.x, game.selected_ball.y);
        game.selected_ball.velocityx = vx;
        game.selected_ball.velocityy = vy;
        ...
        */
        ...
        game.runningBalls.push(game.selected_ball);
 ...
 *
 *****/
window.utils.isMouseOverBall = function(mouse,ball) {
  var r = false;
  if((mouse.x > 0 && mouse.y > 0)&&(ball.x > 0 && ball.y > 0)){
    if(((mouse.x >= (ball.x - ball.radius)) && (mouse.x <= (ball.x + ball.radius)))&&
    ((mouse.y >= (ball.y - ball.radius)) && (mouse.y <= (ball.y + ball.radius)))){
      r = true;
      console.log('over');
    }
  }

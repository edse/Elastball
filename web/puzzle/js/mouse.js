...
Mouse.prototype.mousedown = function(event) {
  ...
  if((this.game.selected_ball == null)&&(this.game.over_ball != null)){
    this.game.selected_ball = this.game.over_ball;
    document.getElementById('selected').value = this.game.selected_ball.id;
  }

 ...
 * @method Game                setSocketId()     Sets the current record's "socket_id" value
 * @method Game                setDateStart()    Sets the current record's "date_start" value
 * @method Game                setDateEnd()      Sets the current record's "date_end" value
 ...
 * @method Game                setSocket()       Sets the current record's "Socket" value
 ...
 * @method Game                setTurns()        Sets the current record's "Turns" collection
 * 
 * @package    elastball
 * @subpackage model

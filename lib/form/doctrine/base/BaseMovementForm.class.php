...
/**
 * Movement form base class.
 *
 * @method Movement getObject() Returns the current form's model object
 *
 * @package    elastball
 * @subpackage form
 ...
 */
abstract class BaseMovementForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('movement[%s]');

...
/**
 * AssetAudioGallery form base class.
 *
 * @method AssetAudioGallery getObject() Returns the current form's model object
 *
 * @package    elastball
 * @subpackage form
 ...
 */
abstract class BaseAssetAudioGalleryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('asset_audio_gallery[%s]');

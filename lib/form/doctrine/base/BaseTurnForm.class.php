...
/**
 * Turn form base class.
 *
 * @method Turn getObject() Returns the current form's model object
 *
 * @package    elastball
 * @subpackage form
 ...
 */
abstract class BaseTurnForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('turn[%s]');
